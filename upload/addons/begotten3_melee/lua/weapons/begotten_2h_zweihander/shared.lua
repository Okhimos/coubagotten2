...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "ZweihanderAttackTable"
SWEP.BlockTable = "ZweihanderBlockTable"
...
SWEP.WElements = {
	["w_zweihander"] = { type = "Model", model = "models/begottenprelude/weapons/zweihander.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 1.557, 7.791), angle = Angle(-82.987, -1.17, -71.3), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}