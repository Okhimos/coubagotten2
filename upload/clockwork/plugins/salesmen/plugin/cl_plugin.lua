...
Clockwork.chatBox:RegisterDefaultClass("ttalk", "ic", function(info)		
	...
	Clockwork.chatBox:Add(info.filtered, nil, color, info.data.name.." говорит \""..info.text.."\"");
end);
...
Clockwork.chatBox:RegisterDefaultClass("tyell", "ic", function(info)		
	...
	Clockwork.chatBox:Add(info.filtered, nil, color, info.data.name.." кричит \""..info.text.."\"");
end);