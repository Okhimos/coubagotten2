...
local FACTION = Clockwork.faction:New("Smog City Pirate");
	...
	FACTION.availablefaiths = {"Faith of the Light", "Faith of the Family", "Faith of the Dark"};
	FACTION.subfactions = {
		{name = "Machinists", subtitle = "Жестокие Убийцы и Работорговцы", description = "Ходят слухи, что запах гниющего мяса, пороха и людских тел разносится на мили от лагерей Скрапперов. Они объединяются с самыми сильными и использую веру как средство, способное даровать силу. Все они падальщики, работорговцы и ублюдки.", attributes = {{Color(0, 225, 0), "(+) Закаленный Дикарь: +30 к максимальному здоровью"}, {Color(0, 225, 0), "(+) Начинает с 8 уровнем Таинства"}, {Color(225, 0, 0), "(-) Подвера «Вольтизм» заблокирована!"}}},
		{name = "Voltists", subtitle = "Технофанатики и Трансгуманисты", description = "Электрозомбированные вольтисты считают себя выше борьбы и желаний, которыми занимается остальное человечество. Они исполняют все прихоти Программы — технологического устройства за пределами человеческого понимания, — и стремятся объединить ее интеллект с Механическим Богом, из которого она создана.", attributes = {{Color(0, 225, 0), "(+) Начинает с 11 уровнем Таинства и открым Вольтизмом"}}},
	};
	FACTION.singleGender = GENDER_MALE;
	FACTION.characterLimit = 1; -- # of characters of this faction a player can have.
	FACTION.names = "glazic";
