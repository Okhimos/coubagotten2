...
local ITEM = Clockwork.item:New("firearm_base");
	ITEM.name = "Скрап Арбалет";
	ITEM.uniqueID = "begotten_scrapbow";
	ITEM.category = "Crossbows";
	ITEM.model = "models/begotten/weapons/w_scrapbow.mdl";
	ITEM.weight = 4;
	ITEM.description = "Арбалет, созданный из скрапа и гнилого дерева.";
...
local ITEM = Clockwork.item:New("firearm_base");
	...
	ITEM.description = "Длинная ржавая труба, которая может стрелять дальнобойными патронами. Почитаемое оружие в Низших Уездах.";
...
local ITEM = Clockwork.item:New("firearm_base");
	...
	ITEM.description = "Оружие, которое наводит ужас на всех.";
