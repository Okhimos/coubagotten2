...
local ITEM = Clockwork.item:New("bodygroup_base")
	ITEM.name = "Шлем Шагалакса-Вожака"
	ITEM.model = "models/begotten_prelude/items/shagalaxchief_helm.mdl"
	ITEM.iconoverride = "begottenprelude/ui/itemicons/shagalaxchief_helm.png"
	ITEM.weight = 3
	ITEM.uniqueID = "gore_shagalaxchief_helm"
	ITEM.category = "Helms"
	ITEM.headReplacement = "models/begotten/heads/shagalaxchief_helmet.mdl";
	ITEM.headSuffix = "_gore";
	ITEM.description = "Хороший дорогой шлем с плюмажем. Только истинный воин может носить его."
	ITEM.requireFaction = {"Goreic Warrior"};
	ITEM.useSound = "armor/plate_damage_02.wav";
	ITEM.overlay = "begotten/zomboverlay/gatekeep1";
	ITEM.excludeSubfactions = {"Clan Grock"};
	...
	ITEM.bluntScale = 0.80; -- reduces blunt damage by 30%
	ITEM.pierceScale = 0.75; -- reduces pierce damage by 30%
	ITEM.slashScale = 0.65; -- reduces slash damage by 40%
	ITEM.bulletScale = 0.65; -- reduces bullet damage by 40%
	ITEM.stabilityScale = 0.65; -- reduces stability damage by 40%
