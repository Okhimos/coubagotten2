...
surface.CreateFont("nx_IntroTextSmalls", {font = "Oranienbaum", size = ScaleToWideScreen(75), weight = 700, antialiase = true, shadow = true})
surface.CreateFont("nov_IntroTextSmallaaaa", {font = "Oranienbaum", size = ScaleToWideScreen(150), weight = 700, antialiase = true, shadow = true})
surface.CreateFont("nov_IntroTextSmallaaaaa", {font = "Oranienbaum", size = ScaleToWideScreen(50), weight = 700, antialiase = true, shadow = false})
surface.CreateFont("nov_IntroTextSmallfaaaaa", {font = "Oranienbaum", size = ScaleToWideScreen(50), weight = 700, antialiase = true, shadow = false})
surface.CreateFont("nov_IntroTextSmallaaafaa", {font = "Oranienbaum", size = ScaleToWideScreen(37), weight = 700, antialiase = true, shadow = true})
surface.CreateFont("nov_IntroTextSmallDETrooper", {font = "Oranienbaum", size = ScaleToWideScreen(24), weight = 700, antialiase = true, shadow = true})
...
local flashes = {"УБЕЙ","ПЛОТЬ","УМРИ","СУКА","ШЛЮХА","ЛИМОНАД","БИЗОН","ОХОТНИК","ПОДЛОСТЬ","ИСТИНА","БЛЯДЬ","УБЕЙ","УБЕЙ","СИЯНИЕ","ГОРЫ","ВОЙНА","ДЕРЕВНЯ","ГОРЯТ","ГНЕЕТ","МУХИ","ПРОГНЕВАЛ","ПАПА","ИЕРАРХИЯ","ТЬМА","СВЕТ","КЛЕТКА","ОТВРАТ","РАСЧИПОВАТЬ","ПОРЕЗАТЬ","КАЛЕЧИТЬ","ЛОРД","ЦЕРКОВЬ","БАШНЯ","НЕНАВИСТЬ","ПОРОЖДЕННЫЙ","СМЕРТЬ","АД","ИЗГОЙ","ТЕРЗАНИЕ","ПРЕДАТЕЛЬ","СОБЛАЗН","ТРУП","ПЛАМЯ","ЗАБЫТЫЙ",}
