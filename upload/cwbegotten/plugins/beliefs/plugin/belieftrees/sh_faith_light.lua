	...
	LIGHT.beliefs = {
		...
		[4] = {
			...
			["emissary"] = {
				...
				subfaith = "Hard-Glazed",
				description = "Открывает ритуалы III уровня «Вера в Свет». Также открывает возможность выплавлять максимилианскую сталь (только если также разблокирован «Мастер-Кузнец»). Расширает максимальный уровень Таинства на 5.",
