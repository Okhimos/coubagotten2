	...
	LIGHT.beliefs = {
		...
		[3] = {
			...
			["fanaticism"] = {
				name = "Фанатик",
				subfaith = "Sol Orthodoxy",
				description = "Увеличивает урон от ближнего боя, выносливости и устойчивости максимум на 50% (при 10% здоровья) по мере снижения вашего здоровья.",
		...
		[4] = {
			...
			["emissary"] = {
				...
				subfaith = "Hard-Glazed",
				description = "Открывает ритуалы III уровня «Вера в Свет». Также открывает возможность выплавлять максимилианскую сталь (только если также разблокирован «Мастер-Кузнец»).",
